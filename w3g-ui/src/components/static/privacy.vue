<template>
    <v-container>
        <h1>Privacy Policy of islanddefense.info</h1>

        <p>islanddefense.info operates the islanddefense.info website, which provides the SERVICE.</p>

        <p>This page is used to inform website visitors regarding our policies with the collection, use, and disclosure
            of Personal Information if anyone decided to use our Service, the Islanddefense.info website.</p>
        ...
        <p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is
            accessible at islanddefense.info, unless otherwise defined in this Privacy Policy.</p>

        <h2>Information Collection and Use</h2>

        <p>No personal information is collected by this site.</p>
        ...
        <p>We may update our Privacy Policy from time to time. Thus, we advise you to review this page periodically for
            ...
            changes are effective immediately, after they are posted on this page. This Privacy Policy was created with
            the <a href="https://gdprprivacypolicy.net">GDPR Privacy Policy Generator</a>.</p>
