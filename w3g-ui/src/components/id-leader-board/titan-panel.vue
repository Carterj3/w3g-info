<template>
    <span> 
        <span class="headline">Top Titans</span>
        <v-data-table class="elevation-1" :headers="headers" :items="titans" hide-actions item-key="name" disable-initial-sort>
            ...
            <template slot="items" slot-scope="props">
                <tr @click="props.expanded = !props.expanded">
                    ...
                    <td>{{ props.item.rating.toFixed(2) }} </td>
